...
// WhoisDomainMonitoring SDK cache feature
...
class WhoisDomainMonitoringCacheFeature extends WhoisDomainMonitoringBaseFeature
{
    ...
    private function _through(WhoisDomainMonitoringContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
