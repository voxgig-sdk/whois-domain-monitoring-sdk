...
// WhoisDomainMonitoring SDK timeout feature
...
class WhoisDomainMonitoringTimeoutFeature extends WhoisDomainMonitoringBaseFeature
{
    ...
    private function _with_timeout(WhoisDomainMonitoringContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(WhoisDomainMonitoringContext $_ctx, float $ms): void
    {
        $client = $this->client;
