...
// WhoisDomainMonitoring SDK debug feature
...
class WhoisDomainMonitoringDebugFeature extends WhoisDomainMonitoringBaseFeature
{
    ...
    private function _finish(WhoisDomainMonitoringContext $ctx, bool $ok): void
    {
