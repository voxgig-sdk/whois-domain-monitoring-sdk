...
// WhoisDomainMonitoring SDK netsim feature
...
class WhoisDomainMonitoringNetsimFeature extends WhoisDomainMonitoringBaseFeature
{
    ...
    private function _simulate(WhoisDomainMonitoringContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(WhoisDomainMonitoringContext $ctx, array $applied): void
    {
        $client = $this->client;
