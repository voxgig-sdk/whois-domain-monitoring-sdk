...
// WhoisDomainMonitoring SDK rbac feature
...
class WhoisDomainMonitoringRbacFeature extends WhoisDomainMonitoringBaseFeature
{
    ...
    private function _required(WhoisDomainMonitoringContext $ctx): ?string
    {
    ...
    private function _reject(WhoisDomainMonitoringContext $ctx, string $required): void
    {
    ...
    private function _track(WhoisDomainMonitoringContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
