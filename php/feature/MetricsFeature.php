...
// WhoisDomainMonitoring SDK metrics feature
...
class WhoisDomainMonitoringMetricsFeature extends WhoisDomainMonitoringBaseFeature
{
    ...
    private function _record(WhoisDomainMonitoringContext $ctx, bool $ok): void
    {
