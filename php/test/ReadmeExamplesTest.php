...
// WhoisDomainMonitoring SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (WhoisDomainMonitoringSDK::test)
...
{
    private const SDK_CLASS = 'WhoisDomainMonitoringSDK';
    ...
    private const SDK_BASE = 'whoisdomainmonitoring_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../whoisdomainmonitoring_sdk.php';
