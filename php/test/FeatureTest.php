...
// WhoisDomainMonitoring SDK feature test
//
...
class FtCtrl extends WhoisDomainMonitoringControl
{
...
class FtClient
{
    ...
    private WhoisDomainMonitoringUtility $utility;

    public function __construct(WhoisDomainMonitoringUtility $utility, array $options)
    {
    ...
    public function get_utility(): WhoisDomainMonitoringUtility
    {
        return $this->utility;
    }
}
...
class FtRecorder
{
    ...
    {
        return function (WhoisDomainMonitoringContext $_ctx, string $url, array $fetchdef): array {
...
class FtHarness
{
    ...
    public WhoisDomainMonitoringContext $rootctx;
    ...
    public function __construct(
        ...
        $utility->fetcher = $server ?? function (WhoisDomainMonitoringContext $_ctx, string $_url, array $fetchdef): array {
        ...
        foreach ($features as $fspec) {
            ...
            $f = WhoisDomainMonitoringConfig::make_feature($name);
    ...
    private static function buildUrl(WhoisDomainMonitoringSpec $spec): string
    {
        $keys = [];
    ...
    public function op(array $o = []): array
    {
        ...
        if (($ctx->out['point'] ?? null) instanceof WhoisDomainMonitoringError) {
        ...
        if (is_array($fetched)) {
            $ctx->response = new WhoisDomainMonitoringResponse($fetched);
        }
    ...
    private function fail(WhoisDomainMonitoringContext $ctx, mixed $err): array
    {
...
class FeatureTest extends TestCase
{
    ...
    public function test_retry_retries_a_transport_error_until_exhausted(): void
    {
        ...
        $clock = new FtClock();
        $n = 0;
        $server = function (WhoisDomainMonitoringContext $ctx, string $_url, array $_fd) use (&$n): array {
            $n++;
