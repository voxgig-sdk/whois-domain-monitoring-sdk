...
// WhoisDomainMonitoring SDK pipeline test
//
...
{
    private static function utility(): WhoisDomainMonitoringUtility
    {
        return new WhoisDomainMonitoringUtility();
    }
    ...
    private static function ctx(array $over = []): WhoisDomainMonitoringContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new WhoisDomainMonitoringContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new WhoisDomainMonitoringOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof WhoisDomainMonitoringError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new WhoisDomainMonitoringOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = WhoisDomainMonitoringMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new WhoisDomainMonitoringOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = WhoisDomainMonitoringMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new WhoisDomainMonitoringOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = WhoisDomainMonitoringMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new WhoisDomainMonitoringSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = WhoisDomainMonitoringMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new WhoisDomainMonitoringResponse([]),
            'result' => new WhoisDomainMonitoringResult([]),
        ]);
        [, $err] = WhoisDomainMonitoringMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new WhoisDomainMonitoringSpec([]),
            'response' => null,
            'result' => new WhoisDomainMonitoringResult([]),
        ]);
        [, $err] = WhoisDomainMonitoringMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new WhoisDomainMonitoringSpec(['step' => 's']),
            'response' => new WhoisDomainMonitoringResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new WhoisDomainMonitoringResult([]),
        ]);
        [, $err] = WhoisDomainMonitoringMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new WhoisDomainMonitoringSpec(['step' => 's']),
            'response' => new WhoisDomainMonitoringResponse(self::resp(200, ['v' => 1])),
            'result' => new WhoisDomainMonitoringResult([]),
        ]);
        [, $err] = WhoisDomainMonitoringMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new WhoisDomainMonitoringSpec(['step' => 's']),
            'response' => new WhoisDomainMonitoringResponse(self::resp(200, ['v' => 2])),
            'result' => new WhoisDomainMonitoringResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        WhoisDomainMonitoringMakeResponse::call($ctx);
    ...
    {
        $preset = new WhoisDomainMonitoringResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new WhoisDomainMonitoringSpec([]),
            'response' => new WhoisDomainMonitoringResponse([]),
            'result' => new WhoisDomainMonitoringResult([]),
        ...
        [$got, $err] = WhoisDomainMonitoringMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new WhoisDomainMonitoringResult([])]);
        [, $err] = WhoisDomainMonitoringMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new WhoisDomainMonitoringSpec([]), 'result' => null]);
        [, $err] = WhoisDomainMonitoringMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new WhoisDomainMonitoringSpec(['step' => 's']),
            'result' => new WhoisDomainMonitoringResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new WhoisDomainMonitoringOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = WhoisDomainMonitoringMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new WhoisDomainMonitoringSpec(['step' => 's']),
            'result' => new WhoisDomainMonitoringResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new WhoisDomainMonitoringOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = WhoisDomainMonitoringMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new WhoisDomainMonitoringResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new WhoisDomainMonitoringSpec([]),
            'result' => new WhoisDomainMonitoringResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = WhoisDomainMonitoringMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = WhoisDomainMonitoringMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new WhoisDomainMonitoringError('boom', 'boom');
        $utility->fetcher = function (WhoisDomainMonitoringContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new WhoisDomainMonitoringSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = WhoisDomainMonitoringMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (WhoisDomainMonitoringContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = WhoisDomainMonitoringMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(WhoisDomainMonitoringResponse::class, $response);
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        WhoisDomainMonitoringMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (WhoisDomainMonitoringContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new WhoisDomainMonitoringSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = WhoisDomainMonitoringMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new WhoisDomainMonitoringResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new WhoisDomainMonitoringSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = WhoisDomainMonitoringMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = WhoisDomainMonitoringMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = WhoisDomainMonitoringMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new WhoisDomainMonitoringResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, WhoisDomainMonitoringDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new WhoisDomainMonitoringResult(['ok' => false])]);
        $this->expectException(WhoisDomainMonitoringError::class);
        WhoisDomainMonitoringDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new WhoisDomainMonitoringResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', WhoisDomainMonitoringMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        WhoisDomainMonitoringMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new WhoisDomainMonitoringBaseFeature();
        $b = new WhoisDomainMonitoringBaseFeature();
        WhoisDomainMonitoringFeatureAdd::call($ctx, $a);
        WhoisDomainMonitoringFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): WhoisDomainMonitoringBaseFeature
    {
        $f = new WhoisDomainMonitoringBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        WhoisDomainMonitoringFeatureAdd::call($ctx, self::named_feature('a'));
        WhoisDomainMonitoringFeatureAdd::call($ctx, self::named_feature('b'));
        $this->assertSame(['a', 'b'], $names());

        $before = self::named_feature('z1');
        $before->_options = ['__before__' => 'b'];
        WhoisDomainMonitoringFeatureAdd::call($ctx, $before);
        $this->assertSame(['a', 'z1', 'b'], $names());

        $after = self::named_feature('z2');
        $after->_options = ['__after__' => 'a'];
        WhoisDomainMonitoringFeatureAdd::call($ctx, $after);
        $this->assertSame(['a', 'z2', 'z1', 'b'], $names());

        $replace = self::named_feature('z3');
        $replace->_options = ['__replace__' => 'z1'];
        WhoisDomainMonitoringFeatureAdd::call($ctx, $replace);
        ...
        WhoisDomainMonitoringFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): WhoisDomainMonitoringContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new WhoisDomainMonitoringSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = WhoisDomainMonitoringPrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_a_raw_apikey_goes_in_as_is(): void
    {
        ...
        WhoisDomainMonitoringPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new WhoisDomainMonitoringResponse(['headers' => null]),
            'result' => new WhoisDomainMonitoringResult([]),
        ]);
        WhoisDomainMonitoringResultHeaders::call($ctx);
    ...
    public function test_result_body_skips_parsing_when_the_body_is_absent(): void
    {
        ...
        WhoisDomainMonitoringResultBody::call($ctx);
