...
class WhoisDomainMonitoringTestRunner
{
    ...
    {
        $live = self::getenv('WHOISDOMAINMONITORING_TEST_LIVE');
        $override = self::getenv('WHOISDOMAINMONITORING_TEST_OVERRIDE');
        ...
        $explain = self::getenv('WHOISDOMAINMONITORING_TEST_EXPLAIN');
