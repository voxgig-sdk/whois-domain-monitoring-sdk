...
// WhoisDomainMonitoring SDK utility: fetcher

class WhoisDomainMonitoringFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; WhoisDomainMonitoringSDK/1.0)';
    ...
    public static function call(WhoisDomainMonitoringContext $ctx, string $fullurl, array $fetchdef): array
    {
