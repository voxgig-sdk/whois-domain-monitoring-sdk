...
// WhoisDomainMonitoring SDK utility: make_options

class WhoisDomainMonitoringMakeOptions
{
    ...
    public static function call(WhoisDomainMonitoringContext $ctx): array
    {
        ...
        //
        // `WhoisDomainMonitoringSchema::optspec()` is built from the model:
        ...
        $optspec = WhoisDomainMonitoringSchema::optspec();
