...
// WhoisDomainMonitoring SDK utility: result_basic

class WhoisDomainMonitoringResultBasic
{
    public static function call(WhoisDomainMonitoringContext $ctx): ?WhoisDomainMonitoringResult
    {
        ...
        if ($result && $response) {
            ...
            if ($result->status >= 400) {
                ...
                if ($result->err) {
                    $prev = ($result->err instanceof WhoisDomainMonitoringError) ? $result->err->msg : (string)$result->err;
