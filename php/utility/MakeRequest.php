...
// WhoisDomainMonitoring SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class WhoisDomainMonitoringMakeRequest
{
    public static function call(WhoisDomainMonitoringContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new WhoisDomainMonitoringResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new WhoisDomainMonitoringResponse($fetched);
        } else {
