...
require_relative 'WhoisDomainMonitoring_types'
...
class WhoisDomainMonitoringSDK
  ...
  def initialize(options = {})
    ...
    feature_opts = WhoisDomainMonitoringHelpers.to_map(VoxgigStruct.getprop(@options, "feature"))
    if feature_opts
      featureorder = VoxgigStruct.getpath(@options, "__derived__.featureorder")
      if featureorder.is_a?(Array)
        featureorder.each do |fname|
          fopts = WhoisDomainMonitoringHelpers.to_map(feature_opts[fname])
          if fopts && fopts["active"] == true
            utility.feature_add.call(@_rootctx, WhoisDomainMonitoringFeatures.make_feature(fname))
          end
        end
      end
    end
  ...
  def get_utility
    WhoisDomainMonitoringUtility.copy(@_utility)
  end
  ...
  def prepare(fetchargs = {})
    ...
    ctrl = WhoisDomainMonitoringHelpers.to_map(VoxgigStruct.getprop(fetchargs, "ctrl")) || {}
    ...
    params = WhoisDomainMonitoringHelpers.to_map(VoxgigStruct.getprop(fetchargs, "params")) || {}
    query = WhoisDomainMonitoringHelpers.to_map(VoxgigStruct.getprop(fetchargs, "query")) || {}
  ...
  def op_denied(op)
    ...
    {
      "ok" => false,
      "err" => WhoisDomainMonitoringError.new(
        "#{op}_allow",
  ...
  def raw_request(fetchargs = {})
    ...
    rescue WhoisDomainMonitoringError => err
    ...
    if fetched.is_a?(Hash)
      status = WhoisDomainMonitoringHelpers.to_int(VoxgigStruct.getprop(fetched, "status"))
  ...
  def graphql(query, variables = nil, ctrl = nil)
    ...
    if errors.is_a?(Array) && !errors.empty?
      ...
      res["ok"] = false
      res["err"] = WhoisDomainMonitoringError.new(
        "graphql_error", "WhoisDomainMonitoringSDK: graphql: #{msg}")
      res["graphql"] = errors
    end
  ...
  def self.test(testopts = nil, sdkopts = nil)
    ...
    sdk = WhoisDomainMonitoringSDK.new(sdkopts)
    sdk.mode = "test"
    sdk
  end
end
