...
require("whois-domain-monitoring_types")
...
local WhoisDomainMonitoringSDK = {}
WhoisDomainMonitoringSDK.__index = WhoisDomainMonitoringSDK
...
WhoisDomainMonitoringSDK._make_feature = _make_feature


function WhoisDomainMonitoringSDK.new(options)
  local self = setmetatable({}, WhoisDomainMonitoringSDK)
  self.mode = "live"
  self.features = {}
  self.options = nil
...
function WhoisDomainMonitoringSDK:options_map()
...
function WhoisDomainMonitoringSDK:get_utility()
  return Utility.copy(self._utility)
end


function WhoisDomainMonitoringSDK:get_root_ctx()
  return self._rootctx
end


function WhoisDomainMonitoringSDK:prepare(fetchargs)
...
function WhoisDomainMonitoringSDK:direct(fetchargs)
...
function WhoisDomainMonitoringSDK:_op_allowed(op)
  local allow = vs.getpath(self.options, "allow.op")
  return type(allow) == "string" and allow:find(op, 1, true) ~= nil
end


function WhoisDomainMonitoringSDK:_op_denied(op)
  local allow = vs.getpath(self.options, "allow.op")
  if type(allow) ~= "string" then allow = "" end
  return {
    ok = false,
    err = "WhoisDomainMonitoringSDK: " .. op .. ": operation not allowed by" ..
...
-- by passing it.
function WhoisDomainMonitoringSDK:_raw_request(fetchargs)
  local utility = self._utility
...
function WhoisDomainMonitoringSDK:graphql(query, variables, ctrl)
  ...
  if type(errors) == "table" and 0 < #errors then
    ...
    res.ok = false
    res.err = "WhoisDomainMonitoringSDK: graphql: " .. msg
    res.graphql = errors
  end
...
function WhoisDomainMonitoringSDK:DnsResult(data)
...
-- Entity access is capitalised (PascalCase) for parity with the other SDKs.
function WhoisDomainMonitoringSDK:Domain(data)
...
-- Entity access is capitalised (PascalCase) for parity with the other SDKs.
function WhoisDomainMonitoringSDK:EmailValidate(data)
...
-- Entity access is capitalised (PascalCase) for parity with the other SDKs.
function WhoisDomainMonitoringSDK:Generate(data)
...
-- Entity access is capitalised (PascalCase) for parity with the other SDKs.
function WhoisDomainMonitoringSDK:Grammar(data)
...
-- Entity access is capitalised (PascalCase) for parity with the other SDKs.
function WhoisDomainMonitoringSDK:Ipn(data)
...
-- Entity access is capitalised (PascalCase) for parity with the other SDKs.
function WhoisDomainMonitoringSDK:Redact(data)
...
-- Entity access is capitalised (PascalCase) for parity with the other SDKs.
function WhoisDomainMonitoringSDK:Ssl(data)
...
-- Entity access is capitalised (PascalCase) for parity with the other SDKs.
function WhoisDomainMonitoringSDK:Utility(data)
...
-- Entity access is capitalised (PascalCase) for parity with the other SDKs.
function WhoisDomainMonitoringSDK:Whoi(data)
...
function WhoisDomainMonitoringSDK.test(testopts, sdkopts)
  sdkopts = sdkopts or {}
  ...
  local sdk = WhoisDomainMonitoringSDK.new(sdkopts)
  sdk.mode = "test"
...
return WhoisDomainMonitoringSDK
