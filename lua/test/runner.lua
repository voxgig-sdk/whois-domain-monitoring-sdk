...
function runner.env_override(m)
  local live = runner.getenv("WHOIS_DOMAIN_MONITORING_TEST_LIVE")
  local override = runner.getenv("WHOIS_DOMAIN_MONITORING_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("WHOIS_DOMAIN_MONITORING_TEST_EXPLAIN")
