...
function runner.env_override(m)
  local live = runner.getenv("WHOISDOMAINMONITORING_TEST_LIVE")
  local override = runner.getenv("WHOISDOMAINMONITORING_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("WHOISDOMAINMONITORING_TEST_EXPLAIN")
