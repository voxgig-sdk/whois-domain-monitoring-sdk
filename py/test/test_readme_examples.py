# WhoisDomainMonitoring SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions WhoisDomainMonitoringSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both WhoisDomainMonitoringSDK(...) and WhoisDomainMonitoringSDK.test(...) become
#      WhoisDomainMonitoringSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "whoisdomainmonitoring_sdk"
_SDK_CLASS = "WhoisDomainMonitoringSDK"
