...
|---|---|---|
| `ts/` | @voxgig-sdk/whois-domain-monitoring-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/whois-domain-monitoring-sdk \
      --repository voxgig-sdk/whois-domain-monitoring-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/whois-domain-monitoring-sdk` shows it, and
`npm trust revoke @voxgig-sdk/whois-domain-monitoring-sdk --id=<id>` removes it.
