...
// WhoisDomainMonitoring SDK audit feature
...
class WhoisDomainMonitoringAuditFeature extends WhoisDomainMonitoringBaseFeature
{
    ...
    private function _emit(WhoisDomainMonitoringContext $ctx, string $outcome): void
    {
