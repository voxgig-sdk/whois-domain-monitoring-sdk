...
// WhoisDomainMonitoring SDK clienttrack feature
...
class WhoisDomainMonitoringClienttrackFeature extends WhoisDomainMonitoringBaseFeature
{
    ...
    public function PostConstruct(WhoisDomainMonitoringContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'WhoisDomainMonitoring-SDK';
