...
// WhoisDomainMonitoring SDK ratelimit feature
...
class WhoisDomainMonitoringRatelimitFeature extends WhoisDomainMonitoringBaseFeature
{
    ...
    private function _acquire(WhoisDomainMonitoringContext $ctx): void
    {
    ...
    private function _track(WhoisDomainMonitoringContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
