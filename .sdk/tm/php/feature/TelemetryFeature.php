...
// WhoisDomainMonitoring SDK telemetry feature
...
class WhoisDomainMonitoringTelemetryFeature extends WhoisDomainMonitoringBaseFeature
{
    ...
    private function _close(WhoisDomainMonitoringContext $ctx, bool $ok): void
    {
