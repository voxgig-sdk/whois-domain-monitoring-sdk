...
// WhoisDomainMonitoring SDK proxy feature
...
class WhoisDomainMonitoringProxyFeature extends WhoisDomainMonitoringBaseFeature
{
    ...
    public function init(WhoisDomainMonitoringContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (WhoisDomainMonitoringContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
