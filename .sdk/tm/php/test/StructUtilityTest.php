...
// WhoisDomainMonitoring SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = WhoisDomainMonitoringOmni::makeStructRunner(
    ...
    {
        return WhoisDomainMonitoringOmni::objmodel(WhoisDomainMonitoringOmni::argval($val));
    }

    /** A single-case fixture value on the comparison side. */
    private static function outval($val)
    {
        return WhoisDomainMonitoringOmni::unmark($val);
    }

    /** A result normalised to the comparison model. */
    private static function resval($val)
    {
        return WhoisDomainMonitoringOmni::structfix($val, Struct::undef());
    }
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(WhoisDomainMonitoringOmni::structfix($now, Struct::undef()))
                        !== json_encode(WhoisDomainMonitoringOmni::structfix($val, Struct::undef()))) {
