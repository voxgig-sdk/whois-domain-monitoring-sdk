...
// WhoisDomainMonitoring SDK utility: graphql
//
...
class WhoisDomainMonitoringGraphql
{
    ...
    // equivalent.
    public static function body(WhoisDomainMonitoringContext $ctx): mixed
    {
    ...
    public static function errors(WhoisDomainMonitoringContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
