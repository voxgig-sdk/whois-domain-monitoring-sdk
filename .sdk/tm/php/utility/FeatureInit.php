...
// WhoisDomainMonitoring SDK utility: feature_init

class WhoisDomainMonitoringFeatureInit
{
    public static function call(WhoisDomainMonitoringContext $ctx, mixed $f): void
    {
        $fname = $f->get_name();
        $fopts = [];
        if ($ctx->options) {
