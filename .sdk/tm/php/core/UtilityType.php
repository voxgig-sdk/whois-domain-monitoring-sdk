...
// WhoisDomainMonitoring SDK utility type

class WhoisDomainMonitoringUtility
{
    ...
    public static function copy(WhoisDomainMonitoringUtility $src): WhoisDomainMonitoringUtility
    {
        $u = new WhoisDomainMonitoringUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
