...
from projectname_sdk.core.control import WhoisDomainMonitoringControl
...
class WhoisDomainMonitoringContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        # Ctrl
        self.ctrl = WhoisDomainMonitoringControl()
        ...
        if isinstance(sp, WhoisDomainMonitoringSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, WhoisDomainMonitoringResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, WhoisDomainMonitoringResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def resolve_op(self, opname):
        ...
        if opname == "":
            return WhoisDomainMonitoringOperation({})
        ...
        op = WhoisDomainMonitoringOperation({
            "entity": entname,
            "name": opname,
            "input": inpt,
            "points": points,
    ...
    def make_error(self, code, msg):
        return WhoisDomainMonitoringError(code, msg, self)
