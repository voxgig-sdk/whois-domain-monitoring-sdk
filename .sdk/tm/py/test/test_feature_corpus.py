# WhoisDomainMonitoring SDK feature corpus test
#
...
def _client(kase):
    ...
    WhoisDomainMonitoringSDK(...), not WhoisDomainMonitoringSDK.test(...): the `test` feature is
    ...
    return WhoisDomainMonitoringSDK(opts)
