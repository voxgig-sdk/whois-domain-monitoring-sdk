...
class WhoisDomainMonitoringTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = WhoisDomainMonitoringTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = WhoisDomainMonitoringTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = WhoisDomainMonitoringTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
