...
func registerTools(server *mcp.Server, client *sdk.WhoisDomainMonitoringSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "whois-domain-monitoring_list",
		Description: "List records from WhoisDomainMonitoring. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "whois-domain-monitoring_load",
		Description: "Load a single record from WhoisDomainMonitoring. " +
...
func runOp(client *sdk.WhoisDomainMonitoringSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.WhoisDomainMonitoringSDK, name string) (sdk.WhoisDomainMonitoringEntity, error) {
