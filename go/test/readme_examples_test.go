...
const testSeed = `map[string]any{"entity": map[string]any{"dns_result": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "domain": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "email_validate": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "generate": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "grammar": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "ipn": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "redact": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "ssl": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "utility": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "whoi": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
