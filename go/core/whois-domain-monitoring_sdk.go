...
type WhoisDomainMonitoringSDK struct {
	Mode     string
...
func (sdk *WhoisDomainMonitoringSDK) OptionsMap() map[string]any {
...
func (sdk *WhoisDomainMonitoringSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *WhoisDomainMonitoringSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *WhoisDomainMonitoringSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *WhoisDomainMonitoringSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *WhoisDomainMonitoringSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *WhoisDomainMonitoringSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("WhoisDomainMonitoringSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *WhoisDomainMonitoringSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *WhoisDomainMonitoringSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("WhoisDomainMonitoringSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
...
func (sdk *WhoisDomainMonitoringSDK) DnsResult(data map[string]any) WhoisDomainMonitoringEntity {
...
func (sdk *WhoisDomainMonitoringSDK) Domain(data map[string]any) WhoisDomainMonitoringEntity {
...
func (sdk *WhoisDomainMonitoringSDK) EmailValidate(data map[string]any) WhoisDomainMonitoringEntity {
...
func (sdk *WhoisDomainMonitoringSDK) Generate(data map[string]any) WhoisDomainMonitoringEntity {
...
func (sdk *WhoisDomainMonitoringSDK) Grammar(data map[string]any) WhoisDomainMonitoringEntity {
...
func (sdk *WhoisDomainMonitoringSDK) Ipn(data map[string]any) WhoisDomainMonitoringEntity {
...
func (sdk *WhoisDomainMonitoringSDK) Redact(data map[string]any) WhoisDomainMonitoringEntity {
...
func (sdk *WhoisDomainMonitoringSDK) Ssl(data map[string]any) WhoisDomainMonitoringEntity {
...
func (sdk *WhoisDomainMonitoringSDK) Utility(data map[string]any) WhoisDomainMonitoringEntity {
...
func (sdk *WhoisDomainMonitoringSDK) Whoi(data map[string]any) WhoisDomainMonitoringEntity {
...
func TestSDK(testopts map[string]any, sdkopts map[string]any) *WhoisDomainMonitoringSDK {
	...
	sdk := NewWhoisDomainMonitoringSDK(sdkopts)
	sdk.Mode = "test"
