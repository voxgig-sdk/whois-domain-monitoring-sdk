...
func registerSDKWords(r *eng.Registry, client *sdk.WhoisDomainMonitoringSDK) {
...
func runOp(client *sdk.WhoisDomainMonitoringSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
