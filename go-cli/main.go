// Command WhoisDomainMonitoring-cli is a CLI + REPL for the WhoisDomainMonitoring SDK,
...
const prompt = "whois-domain-monitoring"
...
func usage(out io.Writer) {
	...
	fmt.Fprintln(out, "Env:      WHOIS_DOMAIN_MONITORING_APIKEY (api key), WHOIS_DOMAIN_MONITORING_BASE (base url override)")
